...
<footer class="footer wrapper"> 
    <div class="footer__inner clearfix" align="left">
        ...
        <article class="block block--col-3">
            ...
            <ul class="footer__list list-unstyled">
                ...
                <li class="footer__item"><a href="//www.ucl.ac.uk/alumni/donations-gbp-single?PROJECT_CODE=U00003">Support us</a></li>
            </ul>
        </article>
        <hr class="clear">
        ...
        <ul class="list-inline footer__list list-unstyled list-inline--divided">
            <li class="text-muted small">Copyright &copy;  2020 UCL</li>
