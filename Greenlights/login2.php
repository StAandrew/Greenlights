    ...
    <hr><p> <br>
        <span>
          <table cellspacing="10" border="3" rules=none>
            <tr bgcolor=silver>
                <td><b>System Log-in</b></td>  
            </tr>
            <tr>
               <td><b>Greenlights is supported from Monday to Friday between 10am and 4pm, UK time.</b></td>
            </tr>
            <tr>
                <td> <b>Username:</b> <br> <input type=text name=username size=100 required>
                </td>
            </tr>
            <tr>
                <td> <b>Password:</b> <br> <input type=text name=password size=100 required>
                </td>
            </tr>
            <tr>
                <td><a href=" <?php echo $authorise_url;?>">
                <center><button class="login-via-ucl" style="vertical-align:middle" href="<?php echo $authorise_url;?>" align=center><span>Login via UCL (recommended)</span></button></center> <hr></a>
                 </td>           
            </tr>
            <tr>
                <td>
